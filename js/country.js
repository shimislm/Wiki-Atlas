...
export default class Country {
    ...
    renderCommon() {
        ...
        myDiv.innerHTML +=`<div class="country-box bg-light border border-2 mx-md-2 rounded-4 opacity-100 text-dark h-100 p-2" data-aos="zoom-out-down" data-aos-duration="1000">
    ...
    render() {
        ...
        document.querySelector(this.parent).append(myDiv);
        myDiv.innerHTML += `<div class=" no-hover bg-light mx-md-0 text-dark col-md-5 py-2 d-flex flex-column align-items-start" data-aos="zoom-in-up" data-aos-duration="1500">
        ...
        map.className = "no-hover p-0 rounded-end-4 text-dark col-md-7 p-0"
        map.innerHTML = `<iframe width="100%" height="100% frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=${this.latlng[0]},${this.latlng[1]}&hl=en&z=5&amp;output=embed" data-aos="zoom-in-up" data-aos-duration="1500"></iframe> `
        // create back button
